...
SupportedLanguage = t.Literal["en", "de", "it", "fr", "pt"]
...
class ProfileUpdateSchema(Schema):
    ...
    language: SupportedLanguage = Field(
        "pt", max_length=7, description="User's preferred language (en, de, it, fr, pt)"
    )
...
class LanguageUpdateSchema(Schema):
    ...
    language: SupportedLanguage = Field(..., description="User's preferred language (en, de, it, fr, pt)")
